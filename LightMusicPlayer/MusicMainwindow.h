...
class MusicMainwindow : public QWidget
{
    Q_OBJECT
    
public:
    explicit MusicMainwindow(QWidget *parent = nullptr);
    ~MusicMainwindow() override;
...
private:
    ...
    void updateBackground(const QPixmap &coverPixmap);
...
private slots:
    ...
    void on_btnMusicDetails_clicked();
    void on_volumeSlider_valueChanged(int value);
    void on_music_like_or_not_clicked();
};
