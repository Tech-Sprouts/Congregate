...
public:
    ...
    void setupUi(QWidget *DownloadManagerWidget)
    {
        ...
        DownloadManagerWidget->resize(569, 297);
...
"}"));
        ...
        m_items->setGeometry(QRect(0, 0, 548, 293));
    ...
    {
        DownloadManagerWidget->setWindowTitle(QApplication::translate("DownloadManagerWidget", "Downloads"));
        m_zeroItemsLabel->setText(QApplication::translate("DownloadManagerWidget", "No downloads"));
    } // retranslateUi
