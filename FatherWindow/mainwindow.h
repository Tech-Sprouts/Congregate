...
#include "../QTalarm/alarmmainwindow.h"
#include "../newWeather/weatherwindow.h"
#include "../LightMusicPlayer/MusicMainwindow.h"
...
private:
    ...
    WeatherWindow * weaw;
    MapWidget * mapw;
    alarmMainWindow * alarmw;
    MusicMainwindow * musicw;
