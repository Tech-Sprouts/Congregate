#ifndef ALARMMAINWINDOW_H
#define ALARMMAINWINDOW_H
...
namespace Ui {
class alarmMainWindow;
}

class alarmMainWindow : public QMainWindow
{
    Q_OBJECT
    
public:
    explicit alarmMainWindow(QWidget *parent = 0);
    ~alarmMainWindow();
    
    void handleTimeResponse(QNetworkReply *reply);
private:
    Ui::alarmMainWindow *ui;
